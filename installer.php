...
if(isset($_REQUEST["ajax"]) && !empty($_REQUEST["ajax"])){
    ...
    <div class="container">
        <div class="jumbotron" style="background-color: transparent;">
            <div class="container text-center">
                ...
                <p style="max-width: 460px; margin:50px auto auto auto;"><span id=".instal1">Checking Status</span></p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var preparebtn = '';
        var composebtn = '';
        var cleanup = '<span id="btncleanup" class="btn btn-primary btn-lg" role="button">Step 3: Finish</span><span id="btnbazaar" class="btn btn-lg" role="button">Install Bazaar</span>';
        //Second, lets set up some reusable functions
        function poll(url) {
        ...
        function phajax(phurl, ph) {};


//Get status on first run
        $( document ).ready(function() {
            $.ajax({
                ...
                .done(function(res) {
                    console.log(res);
                    if (res === 'prepare') {
                        $( ".instal1" ).replaceWith( '<span id="btnprepare" class="instal1 btn btn-primary btn-lg" role="button">Step 1: Prepare</span>' );
